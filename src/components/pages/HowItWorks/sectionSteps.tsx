...
export const SectionSteps = component$(() => {
  return <div class="flex flex-wrap justify-center items-center my-5 gap-4">
  <div class="w-3/4 flex flex-col gap-5 justify-start items-start">
    <div class="flex flex-row justify-start items-center gap-5">
      ...
      <p class="text-3xl">Confirm internet coverage at your address</p>
    </div>
    <div class="flex flex-row gap-5">
      ...
      <p class="text-3xl">Receive your 5G Wi-Fi gateway device.</p>
    </div>
    <div class="flex flex-row gap-5">
      ...
      <p class="text-3xl">Download our app and get set up in minutes.</p>
    </div>
  </div>
