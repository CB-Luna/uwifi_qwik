  ...
  ({
    ...
    return (
      <div
        ...
        class={`${isHollow ? "bg-transparent" : "bg-button-green"} ${whiteBorder ? "border-white" : "border-[#00c207]"} 
        flex w-fit cursor-pointer gap-1 overflow-clip rounded-full border-[2px] items-center from-[#2ed5de] via-[#2e74de] to-[#d201d2] py-3 px-5 text-[20px] font-[300] tracking-tight text-white transition-all hover:border-y-transparent hover:border-l-[#2ed5de] hover:border-r-[#d201d2] hover:bg-gradient-to-r max-[800px]:text-[20px] max-[400px]:text-[18px]`}
      >
        <span>
          <Slot />
        </span>
